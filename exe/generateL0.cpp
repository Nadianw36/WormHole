...
int main(int argc, char *argv[]) {
    ...
    for(int L0_idx = 1; L0_idx < 6; L0_idx++){
        ...
        std::ofstream L0File(FOLDER + graph_name + L0_size_str + "_L0.bin", std::ios::out | std::ios::binary);
        std::ofstream L1File(FOLDER + graph_name + L0_size_str + "_L1.bin", std::ios::out | std::ios::binary);
