#ifndef QBS_SPARSIFY_H_
#define QBS_SPARSIFY_H_
...
namespace QbS
{
    ...
    void sparsify(int k, string graphName, string graph_directory)
    {
        string processedFile = graph_directory + graphName + "_pro.txt";
        string resultFile = graph_directory + graphName + "_spsf_" + to_string(k) + ".txt";
        int countVertex;
        int countEdge;
