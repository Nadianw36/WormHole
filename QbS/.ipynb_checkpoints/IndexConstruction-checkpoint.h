...
#ifndef QBS_INDEXCONSTRCUTION_H_
#define QBS_INDEXCONSTRCUTION_H_
...
namespace QbS
{
    ...
    long indexConstructionEfficient(int k, string graph_name, string graph_directory)
    {
        string processedFile = graph_directory + graph_name + "_pro.txt";
        string resultFile = graph_directory + graph_name + "_indexInfo_" + to_string(k) + ".txt";
        string resultFile2 = graph_directory + graph_name + "_indexInfo_" + to_string(k) + ".txt";
        int countVertex = 0;
        int countEdge = 0;
